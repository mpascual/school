public class Billing {
  ...
  public static void computeBill(double price) {
    ...
    System.out.println("Total price with tax for photo book ordered: $" + totalOrder);
  }
  ...
  public static void computeBill(double price, int quantity) {
    ...
    System.out.println("Total price with tax for photo book ordered: $" + totalOrder + ". Quantity: " + quantity);
  }
  ...
  public static void computeBill(double price, int quantity, double coupon) {
    ...
    System.out.println("Total price with tax for photo book ordered: $" + totalOrder + ". Quantity: " + quantity + ". Discount rate of: " + coupon + "%.");
  }
}
